...
%GCC% -fdiagnostics-color=always -fpermissive -municode -s -O3 C:\Users\Matthias\Documents\code\fadenkreuz\fadenkreuz.cpp fadenkreuz.res -mwindows -lgdi32 -luser32 -o Fadenkreuz.exe